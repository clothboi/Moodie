...
function createMoodboardGrid(container, initialOptions = {}) {
  ...
  function renderOverlayControls(selectedItem, frame, previewResult) {
    ...
    if (isSingleSelectedTile && selectedItem && tileViewportFrame) {
      ...
      const actionBarWidth = selectedItem.colSpan * GRID_SPEC.columnPx;
      const cropBarWidth = selectedItem.colSpan * GRID_SPEC.columnPx;
      ...
      const actionBarLeft = clamp(tileCenterX - actionBarWidth / 2, scrollLeft + horizontalInset, scrollLeft + getViewportWidth() - horizontalInset - actionBarWidth);
      const cropBarLeft = clamp(tileCenterX - cropBarWidth / 2, scrollLeft + horizontalInset, scrollLeft + getViewportWidth() - horizontalInset - cropBarWidth);
